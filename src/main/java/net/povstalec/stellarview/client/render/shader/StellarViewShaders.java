...
public class StellarViewShaders
{
    ...
    public static class ShaderInit
    {
        ...
        {
			programs.add(Pair.of(new CelestialShaderInstance(factory, new ResourceLocation(StellarView.MODID,"rendertype_star"), StellarViewVertexFormat.STAR_POS_COLOR_LY), (shaderInstance) ->
			{
				rendertypeStarShader = (CelestialShaderInstance) shaderInstance;
			}));
			
			programs.add(Pair.of(new CelestialShaderInstance(factory, new ResourceLocation(StellarView.MODID,"rendertype_star_instanced"), DefaultVertexFormat.POSITION), (shaderInstance) ->
			{
			...
			programs.add(Pair.of(new CelestialShaderInstance(factory, new ResourceLocation(StellarView.MODID,"rendertype_star_tex"), StellarViewVertexFormat.STAR_POS_COLOR_LY_TEX), (shaderInstance) ->
			{
				rendertypeStarTexShader = (CelestialShaderInstance) shaderInstance;
			}));
			
			programs.add(Pair.of(new CelestialShaderInstance(factory, new ResourceLocation(StellarView.MODID,"rendertype_star_tex_instanced"), DefaultVertexFormat.POSITION_TEX), (shaderInstance) ->
			{
			...
			programs.add(Pair.of(new CelestialShaderInstance(factory, new ResourceLocation(StellarView.MODID,"rendertype_dust_cloud"), StellarViewVertexFormat.STAR_POS_COLOR_LY_TEX), (shaderInstance) ->
			{
				rendertypeDustCloudShader = (CelestialShaderInstance) shaderInstance;
			}));
			
			programs.add(Pair.of(new CelestialShaderInstance(factory, new ResourceLocation(StellarView.MODID,"rendertype_dust_cloud_instanced"), DefaultVertexFormat.POSITION_TEX), (shaderInstance) ->
			{
