...
public class StellarViewOverworldEffects extends StellarViewSpecialEffects
{
	...
	private static final Moon LUNA = new Moon.DefaultMoon()
		...
		private static final Moon IO = new Moon(Moon.IO_TEXTURE, 0.15F)
				.halo(Moon.IO_HALO_TEXTURE);
		private static final Moon EUROPA = new Moon(Moon.EUROPA_TEXTURE, 0.125F)
				.halo(Moon.EUROPA_HALO_TEXTURE);
		private static final Moon GANYMEDE = new Moon(Moon.GANYMEDE_TEXTURE, 0.25F)
				.halo(Moon.GANYMEDE_HALO_TEXTURE);
		private static final Moon CALLISTO = new Moon(Moon.CALLISTO_TEXTURE, 0.2F)
				.halo(Moon.CALLISTO_HALO_TEXTURE);

		private static final Moon TITAN = new Moon(Moon.TITAN_TEXTURE, 0.25F)
				.halo(Moon.TITAN_HALO_TEXTURE);
