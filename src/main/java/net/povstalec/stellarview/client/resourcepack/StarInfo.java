...
public class StarInfo
{
	...
	{
		return new StarInfo(ResourceLocation.parse(tag.getString(STAR_TEXTURE)), getLODTypes(tag, LOD1_TYPES), getLODTypes(tag, LOD2_TYPES), getLODTypes(tag, LOD3_TYPES), tag.getInt(LOD1_WEIGHT), tag.getInt(LOD2_WEIGHT), tag.getInt(LOD3_WEIGHT));
	}
}
