...
public class AlphaConfigScreen extends Screen
{
	...
	public AlphaConfigScreen(@Nullable Screen parentScreen)
	{
		super(Component.translatable("gui.stellarview.config.alpha"));
    ...
    public void init()
    {
		...
		this.configList.add(new BooleanConfigEntry(Component.translatable("gui.stellarview.disable_sun"), 
				this.width, AlphaConfig.disable_sun));
		
		this.configList.add(new BooleanConfigEntry(Component.translatable("gui.stellarview.disable_moon"), 
				this.width, AlphaConfig.disable_moon));
		this.configList.add(new BooleanConfigEntry(Component.translatable("gui.stellarview.disable_moon_phases"), 
				this.width, AlphaConfig.disable_moon_phases));

		this.configList.add(new SliderConfigEntry(Component.translatable("gui.stellarview.meteor_shower_chance"),
				Component.literal("\u0025"),
				this.width, AlphaConfig.meteor_shower_chance));
		this.configList.add(new SliderConfigEntry(Component.translatable("gui.stellarview.shooting_star_chance"),
				Component.literal("\u0025"),
				this.width, AlphaConfig.shooting_star_chance));

		this.configList.add(new SliderConfigEntry(Component.translatable("gui.stellarview.galaxy_x"),
				Component.empty(),
				this.width, AlphaConfig.milky_way_x));
		this.configList.add(new SliderConfigEntry(Component.translatable("gui.stellarview.galaxy_y"),
				Component.empty(),
				this.width, AlphaConfig.milky_way_y));
		this.configList.add(new SliderConfigEntry(Component.translatable("gui.stellarview.galaxy_z"),
				Component.empty(),
				this.width, AlphaConfig.milky_way_z));

		this.configList.add(new SliderConfigEntry(Component.translatable("gui.stellarview.galaxy_alpha"),
				Component.literal("\u00b0"),
				this.width, AlphaConfig.milky_way_alpha));
		this.configList.add(new SliderConfigEntry(Component.translatable("gui.stellarview.galaxy_beta"),
				Component.literal("\u00b0"),
				this.width, AlphaConfig.milky_way_beta));
		this.configList.add(new SliderConfigEntry(Component.translatable("gui.stellarview.galaxy_gamma"),
				Component.literal("\u00b0"),
				this.width, AlphaConfig.milky_way_gamma));
