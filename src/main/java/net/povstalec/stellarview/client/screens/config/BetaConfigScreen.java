...
public class BetaConfigScreen extends Screen
{
	...
	public BetaConfigScreen(@Nullable Screen parentScreen)
	{
		super(Component.translatable("gui.stellarview.config.beta"));
