...
public class StellarCoordinates
{
	...
	public static Vector3f placeOnSphere(float offsetX, float offsetY, SphericalCoords sphericalCoords, double rotation)
	{
		...
		cartesian.setX((float) (cartesian.x() - polarY * Math.cos(sphericalCoords.phi) * Math.sin(sphericalCoords.theta) - polarX * Math.cos(sphericalCoords.theta)));
		cartesian.setY((float) (cartesian.y() + polarY * Math.sin(sphericalCoords.phi)));
		cartesian.setZ((float) (cartesian.z() - polarY * Math.cos(sphericalCoords.phi) * Math.cos(sphericalCoords.theta) + polarX * Math.sin(sphericalCoords.theta)));
