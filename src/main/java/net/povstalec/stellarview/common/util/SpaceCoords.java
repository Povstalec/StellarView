...
public class SpaceCoords
{
	...
	public static Quaternion getQuaternionf(ClientLevel level, ViewCenter viewCenter, float partialTicks)
	{
		Quaternion q = new Quaternion(0, 0, 0, 1);
		// Inverting so that we can view the world through the relative rotation of our view center
		if(!GeneralConfig.disable_view_center_rotation.get())
			AxisRotation.invertQuaternion(viewCenter.getObjectAxisRotation().quaternionf(), q);
