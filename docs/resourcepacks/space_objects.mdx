...
Space Objects can be rotated in various directions. This rotation can affect the visual appearance, as well as relative positions of its children, as well as how the sky looks on it if it's used as a [View Center](https://moddedmc.wiki/cs/project/stellarview/latest/docs/resourcepacks/view_centers).
