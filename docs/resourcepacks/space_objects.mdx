...
* `right_ascension` **REQUIRED** - [Right ascension](https://en.wikipedia.org/wiki/Equatorial_coordinate_system#Right_ascension) of the object.
    * `hours` *OPTIONAL* - 0 if left empty.
    * `minutes` *OPTIONAL* - 0 if left empty.
    * `seconds` *OPTIONAL* - 0 if left empty.
* `declination` **REQUIRED** - [Declination](https://en.wikipedia.org/wiki/Equatorial_coordinate_system#Declination) of the object.
    * `degrees` *OPTIONAL* - 0 if left empty.
    * `minutes` *OPTIONAL* - 0 if left empty.
    * `seconds` *OPTIONAL* - 0 if left empty.
...
You can compare the coordinates of [Betelgeuse](https://github.com/Povstalec/StellarView/blob/main/src/main/resources/assets/stellarview/stellarview/celestials/star/milky_way/betelgeuse.json#L3) used in Stellar View with ones you can find on [Wikipedia](https://en.wikipedia.org/wiki/Betelgeuse)
