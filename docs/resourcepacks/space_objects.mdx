...
For example: If a star is defined with `coords` (0, 2, 1) and it references a galaxy at `coords` (0, 40, 0) as its parent, the star's absolute position will be (0, 42, 1), `axis_rotation` behaves similarly.
...
Texture Layer definition consists of the following fields:
