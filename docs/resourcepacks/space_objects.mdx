...
Stellar View is scaled 1:1 with the real-life Universe, so it uses a custom coordinate system called Space Coords to define positions of Space Objects in the Universe. This system uses light years and kilometers as base units of measurement.
