...
* `dust_clouds` *OPTIONAL* - Specifies the number of dust clouds that generate in a Star Field. [Min = 0 | Max = 2147483647]
...
* `stars` **REQUIRED** - Specifies the number of stars that generate in a Star Field. [Min = 0 | Max = 2147483647]
