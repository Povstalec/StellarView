...
Axis Rotation of the [Overworld](https://github.com/Povstalec/StellarView/blob/main/src/main/resources/assets/minecraft/stellarview/view_centers/overworld.json):  
```json
