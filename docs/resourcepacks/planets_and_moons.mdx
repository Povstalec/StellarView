...
```json
{
	"parent": "stellarview:planet/milky_way/sol/earth",
...
In the above example, we see the definition of Luna.
We can see a field called *compatibility*. This field is used for compatibility with [Enhanced Celestials](https://www.curseforge.com/minecraft/mc-mods/enhanced-celestials) and specifies the [Dimension](https://minecraft.wiki/w/Dimension) in which the visual effects (changing size and color) for a Moon added by Enhanced Celestials will become apparent.